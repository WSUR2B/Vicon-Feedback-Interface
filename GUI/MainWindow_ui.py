...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinLeftKneeWidth = QSpinBox(self.tab_3)
        self.spinLeftKneeWidth.setObjectName(u"spinLeftKneeWidth")
        self.spinLeftKneeWidth.setMinimum(0)
        self.spinLeftKneeWidth.setMaximum(9999)
        self.spinLeftKneeWidth.setValue(100)

        self.horizontalLayout_21.addWidget(self.spinLeftKneeWidth)
        ...
        self.horizontalLayout_21.addWidget(self.spinRightKneeWidth)
        ...
        self.spinLeftAnkleWidth = QSpinBox(self.tab_3)
        self.spinLeftAnkleWidth.setObjectName(u"spinLeftAnkleWidth")
        self.spinLeftAnkleWidth.setMinimum(0)
        self.spinLeftAnkleWidth.setMaximum(9999)
        self.spinLeftAnkleWidth.setValue(80)

        self.horizontalLayout_24.addWidget(self.spinLeftAnkleWidth)
        ...
        self.spinRightAnkleWidth = QSpinBox(self.tab_3)
        self.spinRightAnkleWidth.setObjectName(u"spinRightAnkleWidth")
        self.spinRightAnkleWidth.setMinimum(0)
        self.spinRightAnkleWidth.setMaximum(9999)
        self.spinRightAnkleWidth.setValue(80)

        self.horizontalLayout_24.addWidget(self.spinRightAnkleWidth)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_26.setText(QCoreApplication.translate("MainWindow", u"Left Knee W (mm):", None))
        self.label_31.setText(QCoreApplication.translate("MainWindow", u"Right Knee W (mm):", None))
        self.label_36.setText(QCoreApplication.translate("MainWindow", u"Left Ankle W (mm):", None))
        self.label_37.setText(QCoreApplication.translate("MainWindow", u"Right Ankle W (mm):", None))
